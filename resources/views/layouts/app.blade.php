            ...
            <div class="col-8">
                ...
                <h3>Enroll a Student</h3>
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" style="background-color: #EEEEEE;"></textarea>
                        <label for="floatingTextarea" >Course Id</label>
                    </div>
                    <br>
                    <div class="form-floating">
                        <textarea class="form-control" placeholder="Leave a comment here" id="floatingTextarea" style="background-color: #EEEEEE;"></textarea>
                        <label for="floatingTextarea" >Student Name</label>
                    </div>
